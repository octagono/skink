...
func Run() (err error) {
   ...
   Receive a file using code:
	...
	// Register tunnel subcommands (conditionally compiled with -tags notunnel).
	// When the notunnel build tag is set, cli_notunnel.go provides a no-op stub.
	// When not set, cli_tunnel.go appends tunnel, exec, and noise-keygen commands.
	registerTunnelCommands(&app.Commands)
